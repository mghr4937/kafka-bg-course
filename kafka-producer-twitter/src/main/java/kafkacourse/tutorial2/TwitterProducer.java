...
public class TwitterProducer {
    ...
    private static final String consumerKey = "xTFdydGKj3wkQBmHZNh5EJS5j";
    private static final String consumerSecret = "1PkxBljlvLuBNP7pgzWTznB8YUis65ve9az8en4WlyQ4nt5OoA";
    ...
    private static final List<String> terms = Lists.newArrayList("Cavani", "Rial", "Pellestri", "Carolina");
